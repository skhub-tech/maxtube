  ...
  return (
    <div className="dark min-h-screen bg-[#0D0D0D] text-white selection:bg-[#FF0000]/30 overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-6 py-3
                         bg-[#0D0D0D]/75 backdrop-blur-xl border-b border-white/5">
        ...
        >
          <div className="relative">
            ...
            <img
              ...
              alt="MaxTube"
              className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-xl object-contain"
            />
          </div>
          <span className="text-lg sm:text-2xl font-black tracking-tight bg-gradient-to-r from-white to-[#FF4444] bg-clip-text text-transparent">
            MaxTube
          </span>
        </motion.a>
        ...
        {/* Telegram CTA */}
        <motion.a
          href="https://t.me/maxtubeofficial"
          target="_blank"
          rel="noopener noreferrer"
          initial={{ opacity: 0, y: -16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.1 }}
          className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-bold
                     bg-[#229ED9]/15 border border-[#229ED9]/30 text-[#54b9e8]
                     hover:bg-[#229ED9]/25 hover:border-[#229ED9]/60 hover:scale-105
